...
public record ColumnDefinition(
	...
	public byte[] getValue() {
		ByteBuffer buffer = ByteBuffer.allocate(columnName.getLength() + columnType.getLength() + columnAttribute.getLength() + META_DATA_LENGTH * 3).order(ByteOrder.BIG_ENDIAN);
